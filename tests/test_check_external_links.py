...
def test_extract_https_links_finds_link_and_image_targets() -> None:
    text = (
        "[docs](https://github.com/frogiraffe/sea-mile/blob/main/docs/GUIDE.md)\n"
        "![badge](https://img.shields.io/pypi/v/sea-mile.svg)\n"
    )
    links = extract_https_links(Path("README.md"), text)
    assert "https://github.com/frogiraffe/sea-mile/blob/main/docs/GUIDE.md" in links
    assert "https://img.shields.io/pypi/v/sea-mile.svg" in links
